...
exports.Trace = exports.TraceTool = exports.getPrecision = exports.generateRandomClientId = exports.getDefaultValue = exports.retry = exports.isNullOrBlank = exports.sleep = exports.SLEEP_MS = void 0;
 ...
 * @param retryCount
 */
const retry = async (func, retryCount = 3, sleep_ms = exports.SLEEP_MS) => {
    ...
    do {
        try {
            ...
            await (0, exports.sleep)(sleep_ms);
        }
    } while (true);
};
exports.retry = retry;
