...
export declare const Asset: typeof ApexAsset;
 ...
 * @param SHORT
 * */
export declare enum SideAction {
    LONG = "LONG",
    SHORT = "SHORT"
}
...
export type PositionsMap = {
    [symbol: string]: PositionResponseObject;
};
...
export interface CreateOrderOptions extends ApiStarkwareSigned {
    symbol: Market;
    side: OrderSide;
    type: OrderType;
    size: string;
...
export declare enum OrderRecordType {
    OPEN = "openOrders",
